...
class TextGeneration(Model):
    ...
    def __init__(self, model=None, tokenizer=None, target_sentences=None, device=None, seed=0):
    ...
    def save(self, out_file):
        ...
        with Serializer(out_file, "shap2.models.TextGeneration", version=0) as s:
    ...
    def load(cls, in_file, instantiate=True):
        ...
        with Deserializer(in_file, "shap2.models.TextGeneration", min_version=0, max_version=0) as s:
