...
def test_random_summary():
    ...
    np.random.seed(0)
    fig = plt.figure()
    shap2.summary_plot(np.random.randn(20, 5), show=False)
...
def test_random_summary_with_data():
    ...
    np.random.seed(0)
    fig = plt.figure()
    shap2.summary_plot(np.random.randn(20, 5), np.random.randn(20, 5), show=False)
    fig.set_layout_engine("tight")
    return fig
...
def test_random_multi_class_summary():
    ...
    np.random.seed(0)
    fig = plt.figure()
    shap2.summary_plot([np.random.randn(20, 5) for i in range(3)], np.random.randn(20, 5), show=False)
    fig.set_layout_engine("tight")
    return fig
...
def test_random_multi_class_summary_legend():
    ...
    np.random.seed(0)
    fig = plt.figure()
    shap2.summary_plot([(2 + np.random.randn(20, 5)) for i in range(3)], 2 + np.random.randn(20, 5), show=False,
                      show_values_in_legend=True)
    fig.set_layout_engine("tight")
    return fig
...
def test_random_summary_bar_with_data():
    ...
    np.random.seed(0)
    fig = plt.figure()
    shap2.summary_plot(np.random.randn(20, 5), np.random.randn(20, 5), plot_type="bar", show=False)
    fig.set_layout_engine("tight")
    return fig
...
def test_random_summary_dot_with_data():
    ...
    np.random.seed(0)
    fig = plt.figure()
    shap2.summary_plot(np.random.randn(20, 5), np.random.randn(20, 5), plot_type="dot", show=False)
    fig.set_layout_engine("tight")
    return fig
...
def test_random_summary_violin_with_data():
    ...
    np.random.seed(0)
    fig = plt.figure()
    shap2.summary_plot(np.random.randn(20, 5), np.random.randn(20, 5), plot_type="violin", show=False)
    fig.set_layout_engine("tight")
    return fig
...
def test_random_summary_with_log_scale():
    ...
    np.random.seed(0)
    fig = plt.figure()
    shap2.summary_plot(np.random.randn(20, 5), use_log_scale=True, show=False)
    fig.set_layout_engine("tight")
    return fig
