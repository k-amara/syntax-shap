...
import shap2
from shap2.utils import assert_import
...
def test_serialization_image_masker_inpaint_telea():
    ...
    original_image_masker = shap2.maskers.Image("inpaint_telea", test_shape)
    ...
    with tempfile.TemporaryFile() as temp_serialization_file:
        ...
        # deserialize masker
        new_image_masker = shap2.maskers.Image.load(temp_serialization_file)
...
def test_serialization_image_masker_inpaint_ns():
    ...
    test_shape = (test_image_height, test_image_width, 3)
    # initialize image masker
    original_image_masker = shap2.maskers.Image("inpaint_ns", test_shape)
...
def test_serialization_image_masker_blur():
    ...
    test_shape = (test_image_height, test_image_width, 3)
    # initialize image masker
    original_image_masker = shap2.maskers.Image("blur(10,10)", test_shape)
...
def test_serialization_image_masker_mask():
    ...
    # initialize image masker
    original_image_masker = shap2.maskers.Image(test_mask, test_shape)
