...
def test_fixed_composite_masker_call():
    ...
    fixed_composite_masker = shap2.maskers.FixedComposite(masker)
...
def test_serialization_fixedcomposite_masker():
    ...
    underlying_masker = shap2.maskers.Text(tokenizer)
    original_masker = shap2.maskers.FixedComposite(underlying_masker)
    ...
    with tempfile.TemporaryFile() as temp_serialization_file:
        ...
        # deserialize masker
        new_masker = shap2.maskers.FixedComposite.load(temp_serialization_file)
