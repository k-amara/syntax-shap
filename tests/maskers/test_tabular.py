...
def test_serialization_independent_masker_dataframe():
    ...
    original_independent_masker = shap2.maskers.Independent(X)
    ...
    with tempfile.TemporaryFile() as temp_serialization_file:
        ...
        # deserialize masker
        new_independent_masker = shap2.maskers.Independent.load(temp_serialization_file)
...
def test_serialization_independent_masker_numpy():
    ...
    with tempfile.TemporaryFile() as temp_serialization_file:
        ...
        # deserialize masker
        new_independent_masker = shap2.maskers.Masker.load(temp_serialization_file)
...
def test_serialization_partion_masker_dataframe():
    ...
    original_partition_masker = shap2.maskers.Partition(X)
    ...
    with tempfile.TemporaryFile() as temp_serialization_file:
        ...
        # deserialize masker
        new_partition_masker = shap2.maskers.Partition.load(temp_serialization_file)
...
def test_serialization_partion_masker_numpy():
    ...
    with tempfile.TemporaryFile() as temp_serialization_file:
        ...
        # deserialize masker
        new_partition_masker = shap2.maskers.Masker.load(temp_serialization_file)
