...
def test_call_function_text_generation():
    ...
    text_generation_for_pretrained_model = shap2.models.TextGeneration(model, tokenizer=tokenizer, device='cpu')
    text_generation_for_model_agnostic_scenario = shap2.models.TextGeneration(f, device='cpu')
