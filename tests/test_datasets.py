...
def test_imagenet50(n_points):
    ...
    X, y = shap2.datasets.imagenet50(n_points=n_points)
...
def test_california(n_points):
    # test that fetch/download works fine
    X, y = shap2.datasets.california(n_points=n_points)
...
def test_linnerud(n_points):
    # test that fetch/download works fine
    X, y = shap2.datasets.linnerud(n_points=n_points)
...
def test_imdb(n_points):
    # test that fetch/download works fine
    X, y = shap2.datasets.imdb(n_points=n_points)
...
def test_diabetes(n_points):
    # test that fetch/download works fine
    X, y = shap2.datasets.diabetes(n_points=n_points)
...
def test_iris(n_points):
    # test that fetch/download works fine
    X, y = shap2.datasets.iris(n_points=n_points)
...
def test_adult(n_points):
    # test that fetch/download works fine
    X, y = shap2.datasets.adult(n_points=n_points)
...
def test_nhanesi(n_points):
    # test that fetch/download works fine
    X, y = shap2.datasets.nhanesi(n_points=n_points)
...
def test_corrgroups60(n_points):
    # test that fetch/download works fine
    X, y = shap2.datasets.corrgroups60(n_points=n_points)
...
def test_independentlinear60(n_points):
    # test that fetch/download works fine
    X, y = shap2.datasets.independentlinear60(n_points=n_points)
...
def test_a1a(n_points):
    # test that fetch/download works fine
    X, y = shap2.datasets.a1a(n_points=n_points)
...
def test_rank():
    # test that fetch/download works fine
    X1, y1, X2, y2, q1, q2 = shap2.datasets.rank()
